# 💳 Nayanpay Unified Agent

> Multi-agent system handling UPI transaction scenarios. Integrates WhatsApp API alerts for payment approvals.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/nayanpay-agent/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-nayanpay-agent.git
cd tp-nayanpay-agent
```
...
```bash
kubectl port-forward deployment/tp-nayanpay-agent 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── nayanpay_agent.py     # Main configuration file
```
...
---
*Generated by [Nayanpay Unified Agent Studio](https://pradeeptalari14.github.io/portfolio/tools/nayanpay-agent/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
